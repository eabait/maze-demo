        ...
        var AStar = {
            ...
            search: function(grid, start, end, heuristic) {
                ...
                while(openHeap.size() > 0) {
                    ...
                    // to closed, process each of its neighbors
                    ...
                    for(var i=0, il = neighbors.length; i < il; i++) {
                        ...
                        // current node, we need to check if the path
                        // we have arrived at this neighbor is the shortest one 
                        // we have seen yet 1 is the distance from a node
                        //  to it's neighbor.  This could be variable for 
                        //  weighted paths.
                        ...
                        if(!beenVisited || gScore < neighbor.g) {
                            ...
                            neighbor.h = neighbor.h || 
                                         heuristic(neighbor.pos, end.pos);
                            neighbor.g = gScore;
                ...
                //No result found. Empty array signifies failure to find path
                return [];
            },
